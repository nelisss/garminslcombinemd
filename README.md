...
### Introduction
This script allow you to combine the markdown files resulting from [garmintomd](https://git.nelisss.net/niels/garmintomd) and [strengthleveltomd](https://git.nelisss.net/niels/strengthleveltomd) into single markdown files.
